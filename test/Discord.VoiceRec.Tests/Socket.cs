...
namespace Discord.VoiceRec.Tests
{
    ...
    {
        [Theory]
        [InlineData("{\"op\":0,\"d\":{\"v\":5,\"user\":\"\",\"private_channels\":[],\"guilds\":[],\"session_id\":3467232525,\"_trace\":\"346343634ss\"},\"e\":\"READY\",\"t\":\"12512c52\"}")]
        [InlineData("{\"op\":0,\"d\":{\"v\":5,\"user\":\"\",\"private_channels\":[],\"guilds\":[],\"session_id\":3467232525,\"_trace\":\"346343634ss\"}}")]
        public void DeserializationOfPayload(string message)
        {
